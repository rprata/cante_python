...
str_first_page = "http://cf.uol.com.br/cante/new/musicas.asp?D=1&P=0&O=&G=English&A=1&B=*&L=1"
str_second_page_init = "http://cf.uol.com.br/cante/new/musicas.asp?D=1&P="
str_second_page_last = "&O=&G=English&A=1&B=*&L=1"
...
if r.status_code == 200:
	...
	for i in range(0, count):
		...
		os.rename(filename, "musicas-internacionais/"+filename)
